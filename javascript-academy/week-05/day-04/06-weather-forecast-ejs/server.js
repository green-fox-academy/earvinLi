...
app.get('/', (req, res) => res.render('DashboardView', { forecasts }));
app.get('/cities/:city', (req, res) => {
  const { weather: weathersToUse } = forecasts.find(forecast => forecast.city === req.params.city);

  res.render('DetailedView', { weathers: weathersToUse });
});
