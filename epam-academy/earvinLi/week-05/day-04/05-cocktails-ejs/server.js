...
app.get('/', (req, res) => {
  let cocktailsToUse = cocktails;
  if (req.query.alcohol) cocktailsToUse = cocktailsToUse.filter(alcohol => alcohol.contains.includes(req.query.alcohol));
  res.render('home', { alcoholList, cocktails: cocktailsToUse });
});
